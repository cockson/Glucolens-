...
def fusion_predict_endpoint(
    ...
    fused = fusion_predict(p_tabular=p_tab, p_retina=p_ret, retina_ok=retina_ok, threshold=thr)
    ...
    rec = PredictionRecord(
        ...
        input_json=json.dumps({"payload": "tabular+optional_retina", "patient_key": payload_obj.get("patient_key")}, sort_keys=True),
